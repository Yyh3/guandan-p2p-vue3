...
| **v0.4.11** | ✅ 当前 | v0.4.10 静态审查 8 bug 修复 | ROUND_END host-only / 过 A 落盘 / MATCH_RESTART 鉴权去重 / 抽 afterMatchRestartRefresh / 音效 unlock 清理 / bgmStyle+sfxMode / scheduleAI difficulty / SettingsView 版本号动态化,34 套件 / 1781/0 单测 |
...
**当前版本**:`v0.4.11`(2026-06-28,v0.4.10 静态审查 8 bug 修复:ROUND_END 鉴权 / 过 A 落盘 / MATCH_RESTART 门禁 / 音效 unlock 清理 / AI 难度全链路 / 版本号动态化)
**首发目标**:v1.0.0(H5)
