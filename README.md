...
- ✅ **完整工程化**:1675 单元测试(v0.4.0 的 862 → 972 → 1609 → 1675,+813 用例,BUG-001~008 + BUG-RC3 + v0.4.9 新功能 + v0.4.10 v049 静态审查 9 bug 修复)+ Chrome CDP 4-tab 联机回归
...
**小计**:**33 测试套件 / 1675 用例 / 0 失败**(v0.4.0 的 862 → 972 → 1609 → 1675,+813 用例)
...
# 测试
npm test                  # 全部 33 套件 / 1675 用例(v0.4.10)
...
- **测试覆盖**:1675 单测(v0.3.0 的 701 → v0.4.0 862 → v0.4.9 1609 → v0.4.10 1675),改算法必加测试
...
| v0.4.10 | ✅ 当前 | 移动端响应式文档化 + v0.4.9 静态审查 9 bug 修复(diff 未定义 / isRestartAfterA 贯通 / MATCH_RESTART seed / relay 白名单 / 真实音效 fallback / setSettings 合并当前值 / IP 端口校验),33 套件 / 1675/0 单测 |
...
- 详细文档:[docs/](./docs/)
- 当前版本:`v0.4.10`(2026-06-28,v0.4.9 6 大功能收官 + 9 个静态审查 bug P0/P1 修复(onHintToggle 崩溃 / isRestartAfterA 贯通 / MATCH_RESTART seed / relay 白名单 / 真实音效 fallback / setSettings 合并当前值 / IP 端口校验)+ 移动端响应式文档化,33 套件 / 1675/0 单测,JDK 21)

---

**最后更新**:2026-06-28(v0.4.10 发布:修复 v0.4.9 静态审查 9 个 bug(V049-01~09 P0/P1/P3)+ 移动端响应式文档化,33 套件 / 1675 单测全过)
