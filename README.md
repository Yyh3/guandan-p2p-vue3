...
- ✅ **完整工程化**:862 单元测试(v0.3.0 的 701 → 862,+161 用例)+ Chrome CDP 4-tab 联机回归
...
| v0.4.0 | ✅ 当前 | v3.x UI 重做收官,16 套件 / 862/0 单测,JDK 21 |
...
- 详细文档:[docs/](./docs/)
- 当前版本:`v0.4.0`(2026-06-27,v3.x 5 阶段 UI 重做收官,16 套件 / 862/0 单测,JDK 21)

---

**最后更新**:2026-06-27(v3.x UI 重做:5 阶段全落地 — tokens + CardPlay + HomeView + RoomView + GameView Desktop/Mobile + HudTop + MainActions,862/0 单测,JDK 21,真机 APK 可发)
