...
- ✅ **完整工程化**:972 单元测试(v0.4.0 的 862 → 972,+110 用例,BUG-001~008 + BUG-RC3-001/002/004/005 修复贡献)+ Chrome CDP 4-tab 联机回归
...
**小计**:**21 测试套件 / 972 用例 / 0 失败**(v0.4.0 的 862 → 972,+110 用例)
...
# 测试
npm test                  # 全部 21 套件 / 972 用例(v0.4.8)
...
| v0.4.8 | ✅ 当前 | P2P 同步修复 8 BUG + host 迁移 game/UI 闭环 + 真实 BGM(7 首 MP3),21 套件 / 972/0 单测 |
...
- 详细文档:[docs/](./docs/)
- 当前版本:`v0.4.8`(2026-06-28,v3.x UI 重做收官 + P2P 同步修复 8 BUG + BUG-RC3 修复 + 真实 BGM 集成,21 套件 / 972/0 单测,JDK 21)

---

**最后更新**:2026-06-28(v0.4.8 修复 BUG-RC3-001/002/004/005:onHostMigrated 顺序改为「先 applySnapshot 再 migrateHost」避免 hand remap 被覆盖 + 用 abandonedSeats 区分「弃赛」和「出完」使新 host 能继续出牌 + 真实 BGM 7 首 Kevin MacLeod CC-BY MP3 + package.json/README/AGENTS 同步版本号与测试数,21 套件 / 972 单测全过)
