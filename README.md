...
- ✅ **完整工程化**:1781 单元测试(v0.4.0 的 862 → 972 → 1609 → 1675 → 1781,+919 用例,BUG-001~008 + BUG-RC3 + v0.4.9 新功能 + v0.4.10 v049 9 bug + v0.4.11 v0410 8 bug)+ Chrome CDP 4-tab 联机回归
...
**小计**:**34 测试套件 / 1781 用例 / 0 失败**(v0.4.0 的 862 → 972 → 1609 → 1675 → 1781,+919 用例)
...
# 测试
npm test                  # 全部 34 套件 / 1781 用例(v0.4.11)
...
- **测试覆盖**:1781 单测(v0.3.0 的 701 → v0.4.0 862 → v0.4.9 1609 → v0.4.10 1675 → v0.4.11 1781),改算法必加测试
...
| v0.4.11 | ✅ 当前 | v0.4.10 静态审查 8 bug 修复(ROUND_END host-only / 过 A 落盘 / MATCH_RESTART 鉴权 / host UI refresh / 音效 unlock 清理 / bgmStyle+sfxMode 入场 / scheduleAI difficulty / 版本号动态化),34 套件 / 1781/0 单测 |
...
- 详细文档:[docs/](./docs/)
- 当前版本:`v0.4.11`(2026-06-28,v0.4.10 静态审查 8 bug 修复(ROUND_END host-only 守卫 / 过 A 状态落盘 / MATCH_RESTART 鉴权 + 重启 ID 去重 / 真实音效成功 unlock 清理 / bgmStyle + sfxMode 入场同步 / scheduleAI 传 state.difficulty / SettingsView 版本号动态化) + 抽 afterMatchRestartRefresh 统一 UI 重置,34 套件 / 1781/0 单测,JDK 21)

---

**最后更新**:2026-06-28(v0.4.11 发布:修复 v0.4.10 静态审查 8 个 bug(V0410-01~08 P0/P1/P2/P3) + 移动端响应式文档化已在 v0.4.10 落地,34 套件 / 1781 单测全过)
