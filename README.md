...
- ✅ **完整工程化**:1837 单元测试(v0.4.0 的 862 → 972 → 1609 → 1675 → 1781 → 1837,+975 用例,BUG-001~008 + BUG-RC3 + v0.4.9 新功能 + v0.4.10 v049 9 bug + v0.4.11 v0410 8 bug + v0.4.12 P2P 回归 56 case + v0.4.13 对抗性审查 34 case)+ Chrome CDP 4-tab 联机回归
...
**小计**:**35 测试套件 / 1837 用例 / 0 失败**(v0.4.0 的 862 → 972 → 1609 → 1675 → 1781 → 1837,+975 用例,含 v0.4.13 对抗性审查 34 case)
...
# 测试
npm test                  # 全部 35 套件 / 1837 用例(v0.4.13)
...
- **测试覆盖**:1837 单测(v0.3.0 的 701 → v0.4.0 862 → v0.4.9 1609 → v0.4.10 1675 → v0.4.11 1781 → v0.4.12 1837,含 v0.4.13 对抗性审查 34 case),改算法必加测试
...
| v0.4.13 | ✅ 当前 | v0.4.12 对抗性审查 8 项 P0/P1/P2 bug 修复(network canBroadcast + broadcastPeerLeave + close broadcast / createGame.destroy / onP2PStateSnapshot 走 refreshUiFromGameState / migrateHost emit turn / onP2PRoundEnd 去重 / onP2PPeerJoin 单一路径 / onP2PPlay ts 去重 + applyPlay 防御),35 套件 / 1837/0 单测 |
...
- 详细文档:[docs/](./docs/)
- 当前版本:`v0.4.13`(2026-06-29,v0.4.12 对抗性审查 8 项 P0/P1/P2 bug 修复(network canBroadcast + broadcastPeerLeave + close broadcast / createGame.destroy / onP2PStateSnapshot 走 refreshUiFromGameState / migrateHost emit turn / onP2PRoundEnd 去重 / onP2PPeerJoin 单一路径 / onP2PPlay ts 去重 + applyPlay 防御),35 套件 / 1837/0 单测,JDK 21)

---

**最后更新**:2026-06-29(v0.4.13 发布:v0.4.12 对抗性审查 8 项 P0/P1/P2 bug 修复——network.js canBroadcast + broadcastPeerLeave + close broadcast PEER_LEAVE;guandan-game.js createGame.destroy;useGameLogic onP2PStateSnapshot 走 refreshUiFromGameState;migrateHost emit turn;onP2PRoundEnd roundId 去重;onP2PPeerJoin 走 applyNetworkPlayers 单一路径;onP2PPlay ts 去重 + applyPlay cards-not-found 防御;35 套件 / 1837 单测全过)
