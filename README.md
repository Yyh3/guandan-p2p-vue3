...
# 3. 跑测试(可选,验证环境)
npm test
# 期望: 52 套件 / 约 2400 用例 / 0 失败 (v0.4.22+ / P0-P1-横屏修复基线)
```
...
**小计**:**52 测试套件 / 约 2400 用例 / 0 失败**(v0.4.22 P0-P1-横屏修复:host 迁移不泄露完整手牌、ROOM_PROBE 定向回复、浏览器扫描后按真实 IP 加入、手机横屏操作区/字号/安全区/手牌显示/预选优化;含 v0416-adversarial-fixes 30 case + v0417-adversarial-fixes 38 case + v0418-adversarial-fixes 20 case + v0419-adversarial-fixes 36 case + v0420-adversarial-fixes 35 case + v0421-adversarial-fixes 25 case + v0422-adversarial-fixes 19 case + v0423-adversarial-fixes 10 case)
...
# 测试
npm test                  # 全部 52 套件 / 约 2400 用例(v0.4.22+ / P0-P1-横屏修复基线)
...
- **测试覆盖**:约 2400 单测(52 套件 / 0 失败,v0.4.22 P0-P1-横屏修复新增回归;含 v0416-adversarial-fixes 30 case + v0417-adversarial-fixes 38 case + v0418-adversarial-fixes 20 case + v0419-adversarial-fixes 36 case + v0420-adversarial-fixes 35 case + v0421-adversarial-fixes 25 case + v0422-adversarial-fixes 19 case + v0423-adversarial-fixes 10 case),改算法必加测试
