...
{
  check('package.json version === 0.4.29', pkg.version === '0.4.29')
  ...
  check('npm test 命令含 v0418-adversarial-fixes.test.js 或其 wrapper 引用该文件',
    /v0418-adversarial-fixes\.test\.js/.test(pkgSrc) || /v0418-adversarial-fixes\.test\.js/.test(wrapperSrc))
}

// ============== 6. V0414-04 已知未做 — follow-up 标记 ==============
console.log('\n=== 6. V0414-04 已知未做(follow-up) — 留 v0.4.20+ ===')
{
  ...
  // 这些留 v0.4.20+ follow-up — 当前测试不强制要求实现
