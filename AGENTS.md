...
# 跑全部测试（39 套件 / 1927 通过 / 0 失败，v0.4.17 收官基线）
npm test
...
│   │   ├── effects.js              # 特效层
│   │   └── *.test.js               # 38 套件 Node assert 单测（1889 case 全过,v0.4.17）
...
测试全是 **Node 原生 assert / console.log**，没用测试框架，简单直接。**v0.4.17 收官：39 套件 / 1927 case 全过。**
...
| `npm test` | 全部 39 套件 | **1927 / 0 fail** (v0.4.17,含 v0412-adversarial-fixes 34 + v0414-adversarial-review 50 + v0.4.15 边缘防御 2 case + v0416-adversarial-fixes 30 case + v0417-adversarial-fixes 38 case) |
