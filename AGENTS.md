...
# 跑全部测试（41 套件 / 1891 通过 / 0 失败，v0.4.20 收官基线）
npm test
...
│   │   ├── effects.js              # 特效层
│   │   └── *.test.js               # 41 套件 Node assert 单测（1891 case 全过,v0.4.20 收官）
...
测试全是 **Node 原生 assert / console.log**，没用测试框架，简单直接。**v0.4.20 收官：41 套件 / 1891 case 全过。**
...
| `npm test` | 全部 41 套件 | **1891 / 0 fail** (v0.4.20,含 v0412-adversarial-fixes 34 + v0414-adversarial-review 52 + v0.4.15 边缘防御 19 + v0416-adversarial-fixes 30 + v0417-adversarial-fixes 38 + v0418-adversarial-fixes 20 + v0419-adversarial-fixes 36 + v0420-adversarial-fixes 35 case) |
